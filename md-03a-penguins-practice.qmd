...
5.  What data types are contained in the variables? (Reminder: [https://rbtl-fs24.github.io/website/slides/lec-02-visualisation.html#/types-of-variables](https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables){.uri}) categorical (species, island, sex), numerical discrete (year), numerical continuous (bill_length_mm, bill_depth_mm, flipper_length_mm, body_mass_g)
...
```{r}
penguins_adelie_big_mouth <- penguins |> 
...
```{r}
penguins |> 
  filter(sex == "female", species == "Chinstrap", (island == "Dream" | island == "Torgensen") )
```
